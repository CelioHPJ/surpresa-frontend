...
export default function App() {
  ...
  useEffect(() => {
    const dataAlvo = new Date('2026-03-04T00:00:00').getTime();
  ...
  <div className="fixed inset-0 bg-red-900/95 z-50 flex flex-col items-center justify-start p-6 overflow-y-auto backdrop-blur-sm">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 max-w-6xl pb-20">
       {[1,2,3,4,5,6].map((num) => (
          <div key={num} className={`bg-white p-8 pt-4 pb-12 rounded-sm shadow-2xl transition-all duration-300 ${num % 2 === 0 ? 'rotate-2' : '-rotate-2'} hover:rotate-0`}>
